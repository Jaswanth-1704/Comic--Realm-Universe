...
const ProfileDetail = () => {
  ...
  const profileUser = {
    ...
    followers: 2543,
    following: 365,
    bio: "Digital comic artist | Tokyo-based | Working on my new series 'Lunar Knights'",
    joined: "March 2022",
  };
            ...
            <div className="relative mb-16">
              ...
              <div className="absolute right-6 top-52 flex space-x-2">
                <Button
                  ...
                  className="comic-button bg-white hover:bg-white border-black text-black"
                >
                ...
                <Button
                  ...
                  className="comic-button bg-[#FF3860] hover:bg-[#FF3860] border-black text-white"
                >
            ...
            <div className="px-6 mt-4">
              <div className="flex items-center">
                ...
                {profileUser.verified && (
                  <Badge className="ml-2 bg-[#00A7E1] text-white border-2 border-black">
                    Verified
                  </Badge>
                )}
              </div>
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="text-gray-600">Joined {profileUser.joined}</div>
              </div>
