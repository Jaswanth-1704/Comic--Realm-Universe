    ...
    <div className="w-64 h-screen sticky top-0 border-r border-border dark:border-gray-700 hidden md:flex flex-col justify-between p-4 dark:bg-gray-900 transition-colors duration-200">
      <div>
        <div className="text-2xl font-bold mb-8 px-4">
          <Link to="/">
            <span className="font-['Mori'] dark:text-white">Comic Realm</span>
          </Link>
        </div>
                  ...
                  <Link to={item.path}>
                    <Button
                      ...
                      className={`w-full justify-start text-base font-medium ${
                        isActive
                          ? "bg-theme text-white border-2 border-black dark:border-gray-600"
        ...
        <Link to="/feed">
          <Button
            className="mt-8 w-full rounded-full comic-button bg-comic-yellow hover:bg-comic-yellow/90 text-black border-2 border-black dark:border-gray-600 font-['Mori']"
            size="lg"
          >
            Post
          </Button>
