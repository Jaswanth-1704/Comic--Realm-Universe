      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            >
              Ready to Join the
              <span className="text-[#FF4F79] ml-3">COMIC</span>
              <br />
              Revolution?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-[#F8F8F8] rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Premium Comics</h3>
              <p className="text-gray-600">
                Access exclusive comic content not available anywhere else!
              </p>
            </div>
            ...
            <div className="bg-[#F8F8F8] rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600">
                Connect with fellow artists and showcase your comic creations!
              </p>
            </div>
            ...
            <div className="bg-[#F8F8F8] rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600">
                Participate in comic discussions, contests, and special events!
              </p>
            </div>
          </div>
